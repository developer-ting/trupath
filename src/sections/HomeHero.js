	...
	return <div className={styles.hero_wrap}>
		<div className={`${styles.banner_section}`}>
			...
			<div className={`${styles.info}`}>
				...
				<p className="text_20">Go against the crystal grain - from the bitter side of sugar to the better side of sweetness. <br/> And return to the Gud ol’ ways - onto the trupath.</p>
			</div>
			...
			<div className={`${styles.leaves}`}>
				<img src={leaves.src} className="img-responsive" alt="Sugarcane" />
			</div>
		</div>
	</div>;
}
